...
wget https://s3.amazonaws.com/gemfire-bootstrap/pivotal-gemfire-9.5.0.tgz
tar -xvf pivotal-gemfire-9.5.0.tgz
mv pivotal-gemfire-9.5.0 /usr/local/
ln -s /usr/local/pivotal-gemfire-9.5.0/ /usr/local/gemfire
